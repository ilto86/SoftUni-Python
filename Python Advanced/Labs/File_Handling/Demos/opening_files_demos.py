...
print_contents('.../Error_Handling-Lab/custom_exceptions_demos.py')

# Absolute - independent of the location of the current file

print_contents('C:\ILTO\PycharmProjects\pythonProject\Python_Advanced\File_Handling-Lab\Demos/demo.txt')
print_contents('C:\ILTO\PycharmProjects\pythonProject\Python_Advanced\File_Handling-Lab\Demos/opening_files_demos.py')
# print_contents('/Users/doncho/repos/softuni-courses/demo-repos/python-advanced-demos/README.md')
print_contents('C:\ILTO\PycharmProjects\pythonProject\Python_Advanced\Error_Handling-Lab/custom_exceptions_demos.py')
